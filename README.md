...
format that preserves types: an R data format (favoring storage
efficiency) or Feather (which is Python-compatible and favors read/write
efficiency). But we haven’t always done this, and in the 2016 returns
there are a lot of intermediate CSVs.
...
![Excel example](README/excel-example.png)
